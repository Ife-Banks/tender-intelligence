...
class Verdict(Base, TimestampMixin):
    ...
    map_reduce_used: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    run_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
    deadline_status: Mapped[str | None] = mapped_column(String(16), nullable=True)
    deadline_utc: Mapped[str | None] = mapped_column(String(64), nullable=True)
    deadline_date: Mapped[str | None] = mapped_column(String(16), nullable=True)
